window.CLASSROOM_CATEGORIES = ["課表查詢", "班務紀錄", "後台管理"];
...
window.CLASSROOM_DATA = [
  ...
  { id: "exam-score1", category: "班務紀錄", tag: "段考成績", title: "段考成績通知單(非主科)", desc: "依段考與原班任課教師整理其他科成績通知單。", filename: "report_card1.html", themeColor: "#d97706" },
  { id: "exam-score2", category: "班務紀錄", tag: "段考成績", title: "段考成績通知單(英文科)", desc: "依段考與原班任課教師整理英文科成績通知單。", filename: "report_card2.html", themeColor: "#d97706" },
  { id: "exam-score3", category: "班務紀錄", tag: "段考成績", title: "段考成績通知單(數學科)", desc: "依段考與原班任課教師整理數學科成績通知單。", filename: "report_card3.html", themeColor: "#d97706" },
  { id: "exam-score4", category: "班務紀錄", tag: "段考成績", title: "段考成績通知單(國文科)", desc: "依段考與原班任課教師整理國文科成績通知單。", filename: "report_card4.html", themeColor: "#d97706" },
  { id: "student-guidance-responses", category: "後台管理", tag: "限定共用", title: "學生輔導紀錄（回覆）", desc: "僅限具有共用資料夾權限的授權帳號查看學生輔導紀錄回覆。", filename: "https://docs.google.com/spreadsheets/d/1NSbmw9PpUnAsjqJpWLTALgiZODqSpdlmv9XscfdmX64/edit?gid=460017595#gid=460017595", themeColor: "#f59e0b", external: true, linkLabel: "查看回覆 ↗" },
